"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }var _module = require('module'); const require = _module.createRequire.call(void 0, import.meta.url);





var _chunkHXBVKRZBjs = require('./chunk-HXBVKRZB.js');

// node_modules/.pnpm/mimic-fn@2.1.0/node_modules/mimic-fn/index.js
var require_mimic_fn = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/mimic-fn@2.1.0/node_modules/mimic-fn/index.js"(exports, module) {
    "use strict";
    _chunkHXBVKRZBjs.init_cjs_shims.call(void 0, );
    var mimicFn = (to, from) => {
...
var require_onetime = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
...
var require_signals = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
...
var require_signal_exit = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/signal-exit@3.0.7/node_modules/signal-exit/index.js"(exports, module) {
    ...
    if (!processOk(process9)) {
      ...
      assert = _chunkHXBVKRZBjs.__require.call(void 0, "assert");
      signals = require_signals();
      isWin = /^win/i.test(process9.platform);
      EE = _chunkHXBVKRZBjs.__require.call(void 0, "events");
...
var require_spinners = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
...
var require_cli_spinners = _chunkHXBVKRZBjs.__commonJS.call(void 0, {
...
_chunkHXBVKRZBjs.init_cjs_shims.call(void 0, );
var import_onetime = _chunkHXBVKRZBjs.__toESM.call(void 0, require_onetime(), 1);
var import_signal_exit = _chunkHXBVKRZBjs.__toESM.call(void 0, require_signal_exit(), 1);
...
// node_modules/.pnpm/ora@8.0.1/node_modules/ora/index.js
var import_cli_spinners = _chunkHXBVKRZBjs.__toESM.call(void 0, require_cli_spinners(), 1);
...
function isUnicodeSupported2() {
  ...
  return Boolean(_process2.default.env.WT_SESSION) || Boolean(_process2.default.env.TERMINUS_SUBLIME) || _process2.default.env.ConEmuTask === "{cmd::Cmder}" || _process2.default.env.TERM_PROGRAM === "Terminus-Sublime" || _process2.default.env.TERM_PROGRAM === "vscode" || _process2.default.env.TERM === "xterm-256color" || _process2.default.env.TERM === "alacritty" || _process2.default.env.TERMINAL_EMULATOR === "JetBrains-JediTerm";
}
...
var StdinDiscarder = class {
  ...
  #realStart() {
    if (_process2.default.platform === "win32" || !_process2.default.stdin.isTTY) {
      return;
    }
    _process2.default.stdin.setRawMode(true);
    _process2.default.stdin.on("data", this.#handleInput);
  ...
  #realStop() {
    ...
    _process2.default.stdin.off("data", this.#handleInput);
    _process2.default.stdin.pause();
...
// node_modules/.pnpm/ora@8.0.1/node_modules/ora/index.js
var import_cli_spinners2 = _chunkHXBVKRZBjs.__toESM.call(void 0, require_cli_spinners(), 1);
var Ora = class {
  #linesToClear = 0;
  ...
  get interval() {
    return _nullishCoalesce(_nullishCoalesce(this.#initialInterval, () => ( this.#spinner.interval)), () => ( 100));
  }
  get spinner() {
    return this.#spinner;
  }
  ...
  #updateLineCount() {
    const columns = _nullishCoalesce(this.#stream.columns, () => ( 80));
...
`);
  ...
  stopAndPersist(options = {}) {
    ...
    const prefixText = _nullishCoalesce(options.prefixText, () => ( this.#prefixText));
...
var export_spinners = import_cli_spinners2.default;




exports.default = ora; exports.oraPromise = oraPromise; exports.spinners = export_spinners;
